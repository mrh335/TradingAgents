...
def create_trader(llm):
    ...
    def trader_node(state, name):
        ...
        #
        # Restrictions intentionally NOT injected here — see the
        # comment in portfolio_manager.py for the design choice. The
        # market view is the agent's job; "can you act on it?" is a
        # separate UI-layer concern surfaced through /restrictions.
